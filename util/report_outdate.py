...
class MyReport():
    def __init__(self):
        self.html_content = '<!doctype html>\
                            ...
                            <table style="font-size:20px;font-family:fangsong;" border="0" width="800" cellspacing="0" align="center">\
                                ...
                                <tr>\
                                    <td>“+”为弱阳性，0.35IU/mL-3.5IU/mL</td>\
                                </tr>\
                                <tr>\
                                    <td>“++”为中阳性，3.5IU/mL-17.5IU/mL</td>\
                                <tr>\
                                    <td>“+++”为强阳性，≥17.5IU/mL</td>\
                                </tr>\
                            </table>\
                            <hr />\
                            <table style="font-size:20px;font-family:fangsong;" border="0" width="800" cellspacing="0" align="center">\
    ...
    def gethtml(self, item_type, reagent_info, nature_aver_str, allergen_list):
        # < 60000: "阴性" "-"
        # < 660000: "弱阳性" "+"
        # < 1100000: "中阳性" "++"
        # > 1100000: "强阳性" "+++"
        ...
        reagent_info_list_3 = [i for i in allergen if i != '']
        # + —结果列表
